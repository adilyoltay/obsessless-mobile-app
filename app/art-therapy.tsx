...
import { ArtTherapyTemplates } from '@/components/illustrations/ArtTherapyTemplates';
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      >
        ...
        {/* Lindsay Braman Style Templates */}
        <View style={styles.templatesSection}>
          <Text style={styles.sectionTitle}>Çizim Şablonları</Text>
          <Text style={styles.sectionSubtitle}>
            Lindsay Braman tarzı terapötik çizim rehberleri
          </Text>
          
          <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.templatesScroll}>
            {Object.entries(ArtTherapyTemplates).map(([key, Template]) => {
              const templateInfo = {
                mandala: { name: 'Mandala', desc: 'Merkezi denge ve simetri' },
                emotionMap: { name: 'Duygu Haritası', desc: 'Duygularınızı keşfedin' },
                breathing: { name: 'Nefes Deseni', desc: 'Sakinleştirici nefes görselleştirmesi' },
                safeSpace: { name: 'Güvenli Alan', desc: 'Kendi huzur alanınızı çizin' },
                freeDrawing: { name: 'Serbest Çizim', desc: 'Özgürce ifade edin' },
              }[key] || { name: key, desc: '' };
              ...
              return (
                <Pressable 
                  ...
                  onPress={() => {
                    Alert.alert(
                      templateInfo.name,
                      `${templateInfo.desc}\n\nBu şablonu kullanarak çizim yapmak ister misiniz?`,
                      [
                ...
                >
                  ...
                  <Text style={styles.templateDesc}>{templateInfo.desc}</Text>
                </Pressable>
              );
            })}
          </ScrollView>
        ...
        <View style={styles.promptsSection}>
          <Text style={styles.sectionTitle}>AI Destekli Öneriler</Text>
          <Text style={styles.sectionSubtitle}>
