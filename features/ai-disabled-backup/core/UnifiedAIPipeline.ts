/**
 * 🚀 Unified AI Pipeline v2.0 - Optimized
 * 
 ...
 * - Telemetry wrapper for consistent tracking
 * 
...
// Import helper classes for optimization
import {
...
export class UnifiedAIPipeline {
  ...
  private readonly telemetryWrapper = getTelemetryWrapper();
  private readonly progressiveEnhancer = getProgressiveEnhancer();
  ...
  private calculateCBTProgressConfidence(records: any[]): number {
    ...
    return this.confidenceCalculator.calculateCBTProgressConfidence(records);
  }
  ...
  private calculateGlobalConfidence(
    ...
    // Delegate to unified confidence calculator
    return this.confidenceCalculator.calculateGlobalConfidence(
      sampleSize,
      dataQuality,
      profileConfidence,
      correlations
